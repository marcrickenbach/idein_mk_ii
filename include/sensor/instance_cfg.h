/** ****************************************************************************
 * @brief Sensor instance configuration interface.
 */

#ifndef FKMG_SENSOR_INSTANCE_CFG_H
#define FKMG_SENSOR_INSTANCE_CFG_H
...
struct Sensor_Instance_Cfg{
    ...
    /* Required: for queuing state machine events (Sensor_SM_Evt). */
    struct{
     ...
     * callback is sent event with signal k_Sensor_Sig_Instance_Initialized. NULL
     * skips callback. */
...
#endif /* FKMG_SENSOR_INSTANCE_CFG_H */
