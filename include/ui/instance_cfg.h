/** ****************************************************************************
 * @brief UI instance configuration interface.
 */

#ifndef FKMG_UI_INSTANCE_CFG_H
#define FKMG_UI_INSTANCE_CFG_H
...
struct UI_Instance_Cfg{
    ...
    /* Required: for queuing state machine events (UI_SM_Evt). */
    struct{
     ...
     * callback is sent event with signal k_UI_Sig_Instance_Initialized. NULL
     * skips callback. */
    UI_Listener_Cb cb;
};
