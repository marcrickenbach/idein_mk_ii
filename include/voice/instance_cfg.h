/** ****************************************************************************
 * @brief Voice instance configuration interface.
 */

#ifndef FKMG_VOICE_INSTANCE_CFG_H
#define FKMG_VOICE_INSTANCE_CFG_H
...
struct Voice_Instance_Cfg{
    ...
    /* Required: for queuing state machine events (Voice_SM_Evt). */
    struct{
     ...
     * callback is sent event with signal k_Voice_Sig_Instance_Initialized. NULL
     * skips callback. */
...
#endif /* FKMG_VOICE_INSTANCE_CFG_H */
